                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="javascript:void(0);" class="btn btn-primary btn-xs importList">Import Area List</a>
            ...
            <form role="form"  method="post" enctype="multipart/form-data" id="cityForm">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="hidden" id="city_id" name="city_id" value="{{$id}}>
                    </div>
                    <div class="form-group">
                        <label> Slug </label>
...
var dTable = $(document).ready(function(){
    ...
    $("body").on("click", ".delete", function () {
        ...
        $.ajax({
            ...
            url: '<?php echo route("delete-area"); ?>',
            data: form_data,
            success: function (msg) {
    ...
    $("body").on("click", ".importList", function () {
        ...
        $.ajax({
            ...
            url: '<?php echo route("import-areas-list"); ?>',
            data: form_data,
            success: function (msg) {
                // location.reload();
            },
