...
$(function () {
    ...
    $(document).ready(function () {
        ...
        c.owlCarousel({ navigation: !1, pagination: !1, items: 5, itemsDesktopSmall: [979, 3], itemsTablet: [768, 3], itemsTabletSmall: [660, 2], itemsMobile: [400, 1] }),
            ...
            $(".list-view,#ajaxTabs li a").click(function (e) {
                e.preventDefault(),
                    ...
                    $(".category-list-wrapper").hasClass("property-list") ? $(".item-list .add-desc-box").removeClass("col-md-9").addClass("col-md-6") : $(".item-list .add-desc-box").removeClass("col-md-9").addClass("col-md-7");
            }),
            $(".grid-view").click(function (e) {
                e.preventDefault(),
                    ...
                    $(".category-list-wrapper").hasClass("property-list");
            }),
            $(".compact-view").click(function (e) {
                e.preventDefault(),
                    ...
                    $(".category-list-wrapper").hasClass("property-list") ? $(".item-list .add-desc-box").addClass("col-md-9").removeClass("col-md-6") : $(".item-list .add-desc-box").addClass("col-md-9").removeClass("col-md-7");
            }),
        ...
        var r = {},
            d = {};
        (d = a ? ((r = { right: "-251px" }), { right: "0" }) : ((r = { left: "-251px" }), { left: "0" })),
